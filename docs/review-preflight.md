...
34. Shared provider artifacts logic: commit/path normalization, variant allowlist, and atomic file-write behavior must come from shared helpers (not duplicated across provider pipeline modules).
